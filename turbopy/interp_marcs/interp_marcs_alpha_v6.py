...
check_file_exists=True, optimize=False, extrapol=False):
  ...
  Output: path to the file that was written
  -------
  """
  ...
  if check_file_exists:
      ...
      output_model_path=output_model_path, geometry=geometry):
        return construct_model_filename(teff, logg, feh, alphafe,
  ...
  if not in_grid and not extrapol:
      raise ValueError(f"Input values outside of grid boundaries")
      #return ""
  ...
  if (not extrapol) and (not interp_flag):
      ...
      print(models)
      raise ValueError('Interpolation FAILED: Necessary grid points do not exist')
      #return ""
  ...
  if extrapol and (not interp_flag):
      ...
      if not interp_flag:
         raise ValueError("Extrapolation FAILED: Necessary grid points do not exist")
...
output_model_path='.', geometry='sph'):
    ...
    # note: APJ is removing the check for the file in the input path
